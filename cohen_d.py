...
IN_DIR='/Users/jessedesimone/Desktop'
OUT_DIR='/Users/jessedesimone/Desktop'
infile='test_data.csv'
outfile='test_data_cohen.csv'
...
#test for cohen function
#cohen(df, grp_var, grp1, grp2, 'roi1')
...
#run cohen function for all columns
